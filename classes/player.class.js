const CLASS_BRUTE = 0;
const CLASS_RUNNER = 1;
const CLASS_ENGINEER = 2;
const CLASS_SMUGGLER = 3;
const CLASS_PILOT = 4;
...
Player = function(){
	...
	this.changeMaxHealth = function(dh){
	...
	this.changeStrength = function(ds){
	...
	this.setCurrentWeapon = function(wpn){
	...
	this.setCurrentArmor = function(arm){
